...
function authTokenv2(req,res,next){       
...
route.post('/activities',authTokenv2,(req,res)=>{
...
route.delete('/activities/:id',authTokenv2,(req,res)=>{
...
route.put('/activities/:id',authTokenv2,(req,res)=>{
