...
route.get('/users_activities',(req,res)=>{  
...
route.get('/users_activities/:id',(req,res)=>{
...
route.get('/relations_user/:id',(req,res)=>{
...
route.get('/relations_activity/:id',(req,res)=>{
...
route.post('/users_activities',(req,res)=>{
...
route.delete('/users_activities/:id',(req,res)=>{
...
route.put('/users_activities/:id',(req,res)=>{
